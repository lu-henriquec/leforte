...
function thememount_body_classes($bodyClass){
	...
	$topbar 	 = ( isset($apicona['show_topbar']) && $apicona['show_topbar']=='0' ) ? $apicona['show_topbar'] : '';
...
function tm_apiconaadv_post_nav() {
	...
	<nav class="navigation post-navigation">
		<div class="nav-links">
			<?php previous_post_link( '%link', __( '<span class="meta-nav"></span> Previous', 'apiconaadv' ) ); ?>
			<?php next_post_link( '%link', __( 'Next <span class="meta-nav"></span>', 'apiconaadv' ) ); ?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
}
