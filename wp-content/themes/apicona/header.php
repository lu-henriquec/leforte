          ...
          <div id="navbar"<?php echo $navbarClass; ?>>
            <nav id="site-navigation" class="navigation main-navigation" data-sticky-height="<?php echo $tm_sticky_header_height; ?>">
			  ...
			  if( function_exists('is_woocommerce') && $wc_header_icon=='1' ){
				  global $woocommerce;
				  $header_controls .= '<div class="thememount-header-cart-link-wrapper"> <a href="'. $woocommerce->cart->get_cart_url() .'" class="thememount-header-cart-link"><i class="fa fa-shopping-cart"></i> <span class="thememount-cart-qty"> <span class="cart-contents">&nbsp;&nbsp;</span></span> </a> </div>';
			  }
